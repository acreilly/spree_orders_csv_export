Spree::Admin::BaseController.class_eval do
  def orders_list_actions
    ...
    headers = ["Order Date", "Order #", "Type", "Shipping Method", "Email", "Name", "Company", "Address 1", "Address 2", "City", "State", "Zip", "Country", "Weight (oz)", "Total Items", "Total", "Subtotal", "Handling", "Shipping", "Comments"]
